...
@Component({
  selector: 'app-inventario-insertar',
  templateUrl: './inventario-insertar.component.html',
  styleUrls: ['./inventario-insertar.component.css']
})
export class InventarioInsertarComponent implements OnInit {
  form:FormGroup;
  articulo:Articulo;
  ...
  onSubmit(): void {
    ...
    this.articuloService.registrar(this.articulo).subscribe(response => {
      if(response==true)
      {
